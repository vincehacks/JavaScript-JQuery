...
$(function(){
  ...
  $('input').on('keyup',function(event){
    ...
    for(var i = 0; i < foundMovies.length; i++){
      ...
      $table.html('<tr><th>Title</th></tr><td>'+foundMovies[i].title+'</td>'+
      '<tr><th>Release Date</th></tr><td>'+foundMovies[i].releaseDate+'</td>'+
      '<tr><th>Rating</th></tr><td>'+foundMovies[i].rating+'</td>'+
      '<tr><th>Director</th></tr><td>'+foundMovies[i].director+'</td>'+
      '<tr><th>Actors</th></tr><td>'+foundMovies[i].actors+'</td>');
